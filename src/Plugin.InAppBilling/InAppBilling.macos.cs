...
namespace Plugin.InAppBilling
{
	...
	public class InAppBillingImplementation : BaseInAppBilling
	{
        ...
        /// <returns></returns>
        public async override Task<InAppBillingPurchase> PurchaseAsync(string productId, ItemType itemType, string obfuscatedAccountId = null, string obfuscatedProfileId = null, string subOfferToken = null, bool shouldConsoleLog = false, CancellationToken cancellationToken = default)
		{
			Init();
